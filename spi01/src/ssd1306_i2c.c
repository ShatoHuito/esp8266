...
void sendCommand(uint8_t command_s)
{
	...
	I2C_SendBytesByAdrUserI2C(OLED_adress, temp_ssd1306, 2);
...
void OLED_print_all_screen(void)
{
	...
	{
		LCD_Goto(0, i);
		I2C_SendBytesByAdrUserI2C(OLED_adress, temp_screen[i++], 129);
...
void LCD_Char(unsigned int c)
{
	...
	I2C_SendBytesByAdrUserI2C(OLED_adress, temp_char_ssd1306, 7);
